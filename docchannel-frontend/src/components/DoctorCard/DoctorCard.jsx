    ...
    <>
      <div className="flex flex-col sm:flex-row justify-around items-center gap-3 sm:gap-4 bg-[#D9D9D9]/55 border-l-[#72A6BB] border-l-4 sm:border-l-5 rounded-sm p-3 sm:p-4">
        ...
        <div className="flex flex-col gap-2 justify-center w-full sm:w-auto">
          <button className="flex items-center justify-center gap-2 font-nunito font-semibold bg-[#72A6BB] px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-md text-white text-xs sm:text-sm md:text-base hover:bg-[#5a8a9d] active:bg-[#4a7a8d] transition whitespace-nowrap w-full sm:w-auto">
